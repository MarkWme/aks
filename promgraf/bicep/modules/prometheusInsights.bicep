resource UXRecordingRulesRuleGroup_aks_uarwl 'Microsoft.AlertsManagement/prometheusRuleGroups@2023-03-01' = {
  name: 'UXRecordingRulesRuleGroup - aks-uarwl'
  location: 'uksouth'
  properties: {
    description: 'UX Recording Rules for Linux'
    scopes: [
      '/subscriptions/0721201f-78df-41f1-9dad-adc0378bcc37/resourcegroups/promgraf/providers/microsoft.monitor/accounts/promgraf'
      '/subscriptions/0721201f-78df-41f1-9dad-adc0378bcc37/resourcegroups/aks-uarwl/providers/microsoft.containerservice/managedclusters/aks-uarwl'
    ]
    clusterName: 'aks-uarwl'
    interval: 'PT1M'
    enabled: true
    rules: [
      {
...
resource UXRecordingRulesRuleGroup_Win_aks_uarwl 'Microsoft.AlertsManagement/prometheusRuleGroups@2023-03-01' = {
  name: 'UXRecordingRulesRuleGroup-Win - aks-uarwl'
  location: 'uksouth'
  properties: {
