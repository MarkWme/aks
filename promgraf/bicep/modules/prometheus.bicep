...
var dceName = length('MSProm-${azureMonitorWorkspaceLocation}-${clusterName}') <= 44 ? 'MSProm-${azureMonitorWorkspaceLocation}-${clusterName}' : substring('MSProm-${azureMonitorWorkspaceLocation}-${clusterName}', 0, 44)
var dcrName = length('MSProm-${azureMonitorWorkspaceLocation}-${clusterName}') <= 64 ? 'MSProm-${azureMonitorWorkspaceLocation}-${clusterName}' : substring('MSProm-${azureMonitorWorkspaceLocation}-${clusterName}', 0, 64)
...
module azuremonitormetrics_dcra_clusterResourceId './dcra.bicep' = {
...
module azuremonitormetrics_profile_clusterResourceId './aksMonitorProfile.bicep' = {
